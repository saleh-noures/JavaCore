 ...
 * 2- Threads are independent because they all have separate path of execution that�s the reason if an exception occurs in one thread, it doesn�t affect the execution of other threads.
